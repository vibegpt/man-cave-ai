...
export default function Page() {
  return (
    <>
      <Head>
        <title>Man Cave Signs | ManCaveAI</title>
        <meta name="description" content="Generate man cave signs concepts from a photo in seconds, then shop a recommended list." />
      </Head>
      <main style={{ maxWidth: 960, margin: "0 auto", padding: "32px 16px", lineHeight: 1.6 }}>
        <header style={{ marginBottom: 24 }}>
          <h1 style={{ fontSize: 36, margin: "0 0 12px" }}>Man Cave Signs</h1>
        ...
        <section style={{ margin: "28px 0" }}>
          ...
          <p style={{ opacity: 0.8 }}>
            “man cave signs”, “man cave sign”, “custom man cave signs”, “personalized man cave signs”, “signs for a man cave”, “man cave neon sign”, “signs for man cave”, “man cave neon signs”, “customizable man cave signs”, “neon signs for man cave”.
          </p>
        </section>
