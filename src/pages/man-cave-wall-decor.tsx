...
export default function Page() {
  return (
    <>
      <Head>
        <title>Man Cave Wall Decor | ManCaveAI</title>
        <meta name="description" content="Generate man cave wall decor concepts from a photo in seconds, then shop a recommended list." />
      </Head>
      <main style={{ maxWidth: 960, margin: "0 auto", padding: "32px 16px", lineHeight: 1.6 }}>
        <header style={{ marginBottom: 24 }}>
          <h1 style={{ fontSize: 36, margin: "0 0 12px" }}>Man Cave Wall Decor</h1>
        ...
        <section style={{ margin: "28px 0" }}>
          ...
          <p style={{ opacity: 0.8 }}>
            “man cave wall decor”, “man cave wall art”, “man cave paintings”, “wall art for a man cave”, “man cave decorations for wall”, “wall art for man cave”, “man cave wall decor ideas”, “man cave wall decoration”, “man cave wall decorations”.
          </p>
        </section>
