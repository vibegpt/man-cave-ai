...
export default function Page() {
  return (
    <>
      <Head>
        <title>Man Cave Shed | ManCaveAI</title>
        <meta name="description" content="Generate man cave shed concepts from a photo in seconds, then shop a recommended list." />
      </Head>
      <main style={{ maxWidth: 960, margin: "0 auto", padding: "32px 16px", lineHeight: 1.6 }}>
        <header style={{ marginBottom: 24 }}>
          <h1 style={{ fontSize: 36, margin: "0 0 12px" }}>Man Cave Shed</h1>
        ...
        <section style={{ margin: "28px 0" }}>
          ...
          <p style={{ opacity: 0.8 }}>
            “man cave shed”, “storage shed man cave”, “man cave sheds”, “garden shed man cave”, “pole barn man cave”, “man cave shed ideas”, “shed man cave”, “shed man cave ideas on a budget”, “man cave pole barn loft”, “man cave shed bar ideas”.
          </p>
        </section>
