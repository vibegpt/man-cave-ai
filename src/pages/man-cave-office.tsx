...
export default function Page() {
  return (
    <>
      <Head>
        <title>Man Cave Office Ideas | ManCaveAI</title>
        <meta name="description" content="Generate man cave office ideas concepts from a photo in seconds, then shop a recommended list." />
      </Head>
      <main style={{ maxWidth: 960, margin: "0 auto", padding: "32px 16px", lineHeight: 1.6 }}>
        <header style={{ marginBottom: 24 }}>
          <h1 style={{ fontSize: 36, margin: "0 0 12px" }}>Man Cave Office Ideas</h1>
        ...
        <section style={{ margin: "28px 0" }}>
          ...
          <p style={{ opacity: 0.8 }}>
            “man cave office ideas”, “man cave office”, “man cave and office”, “home office man cave”, “man cave home office ideas”, “home office and man cave”, “small man cave office ideas”.
          </p>
        </section>
