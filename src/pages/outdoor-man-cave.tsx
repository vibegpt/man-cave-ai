...
export default function Page() {
  return (
    <>
      <Head>
        <title>Outdoor Man Cave | ManCaveAI</title>
        <meta name="description" content="Generate outdoor man cave concepts from a photo in seconds, then shop a recommended list." />
      </Head>
      <main style={{ maxWidth: 960, margin: "0 auto", padding: "32px 16px", lineHeight: 1.6 }}>
        <header style={{ marginBottom: 24 }}>
          <h1 style={{ fontSize: 36, margin: "0 0 12px" }}>Outdoor Man Cave</h1>
        ...
        <section style={{ margin: "28px 0" }}>
          ...
          <p style={{ opacity: 0.8 }}>
            “outdoor man cave”, “backyard man cave”, “backyard man cave ideas”, “low budget backyard man cave”, “outdoor man cave ideas”, “man cave outdoor”.
          </p>
        </section>
