...
export default function SEOTool({ defaultStyle = 'gaming' }: SEOToolProps) {
      ...
      {appState === 'upload' && (
        <div className="bg-[#141414] rounded-2xl border border-white/10 shadow-xl p-8">
          ...
          <div
            ...
            onDrop={handleDrop}
            onClick={() => document.getElementById('seo-file-input')?.click()}
          ...
          >
            ...
            <input type="file" id="seo-file-input" className="hidden" accept="image/*" onChange={handleFileInput} />
          </div>
